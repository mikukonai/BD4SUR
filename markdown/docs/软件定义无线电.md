...
![RTL-SDR框图（参考资料[8]）](./image/sdr/RTL-SDR-Block-Diagram-2.png)

![RTL-SDR框图（参考资料[3]）](./image/sdr/RTL-SDR-Block-Diagram.png)

![RTL-SDR行为级模型（参考资料[3]）](./image/sdr/RTL-SDR-Behavioral-Model.png)

![RTL2832U框图（来自Datasheet）](./image/sdr/RTL2832U.png)

![R820T框图（来自Datasheet）](./image/sdr/R820T.png)
...
- 10 / [有关一款上变频模块的资料](https://www.nooelec.com/store/sdr/sdr-addons/ham-it-up-plus-pcb.html)
